class DustStoneLargeSkill extends BaseSkill {
    constructor() {
        super('dust_stone_large', 'skillDustStoneLarge', 'skillDustStoneLargeDesc', SkillTier.TIER3);
    }

    // Centered at target as top-left of 3x3
    isValidTarget(x, y, step, selectedCell) {
        return x >= 0 && x < BOARD_SIZE - 2 && y >= 0 && y < BOARD_SIZE - 2;
    }
...
window.DustStoneLargeSkill = DustStoneLargeSkill;
