class DustStoneGiantSkill extends BaseSkill {
    constructor() {
        super('dust_stone_giant', 'skillDustStoneGiant', 'skillDustStoneGiantDesc', SkillTier.TIER4);
    }

    // Centered at target as top-left of 4x4
    isValidTarget(x, y, step, selectedCell) {
        return x >= 0 && x < BOARD_SIZE - 3 && y >= 0 && y < BOARD_SIZE - 3;
    }
...
window.DustStoneGiantSkill = DustStoneGiantSkill;
