class PentaKillSkill extends BaseSkill {
    constructor() {
        super('penta_kill', 'skillPentaKill', 'skillPentaKillDesc', SkillTier.TIER5);
        this.endsTurn = true;
    }
    ...
    async applyEffect(step, targetX, targetY, selectionHistory, manager) {
        ...
        if (typeof addLog === 'function') {
            addLog(`${label} Penta Kill executed`, p === BLACK ? 'black' : 'white');
        }
    }
}

window.PentaKillSkill = PentaKillSkill;
